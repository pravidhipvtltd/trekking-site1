  ...
  return (
    <section ref={containerRef} className="py-32 md:py-44 overflow-hidden">
      <div className="mb-16 md:mb-20 px-4 sm:px-6 lg:px-8">
        ...
        >
          From iconic routes to hidden gems. Each destination is a chapter in
          your journey.
        </motion.p>
      </div>
      ...
      <div className="relative">
        ...
        {/* Gradient fade edges */}
        <div className="absolute left-0 top-0 bottom-12 w-24 bg-gradient-to-r from-charcoal-900 to-transparent pointer-events-none z-10" />
        <div className="absolute right-0 top-0 bottom-12 w-24 bg-gradient-to-l from-charcoal-900 to-transparent pointer-events-none z-10" />
    ...
    >
      <Link to="/contact" className="block group">
        <div className="relative overflow-hidden rounded-2xl aspect-[4/5] shadow-2xl">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-80 group-hover:from-black/80 transition-all duration-700" />
          <div className="absolute inset-0 p-8 flex flex-col justify-end">
            ...
            <motion.span className="inline-flex items-center gap-2 text-primary-400 font-semibold text-sm uppercase tracking-wider mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              Explore
              <svg
                className="w-5 h-5"
                fill="none"
