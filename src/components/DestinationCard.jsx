    ...
    <div className="group">
      <Link to={detailUrl} className="block">
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-95 group-hover:from-black/95 group-hover:via-black/60 transition-all duration-500" />
          ...
          <div className="absolute inset-0 p-8 flex flex-col justify-end">
            ...
            <motion.span
              className="inline-flex items-center gap-2 text-primary-400 font-semibold text-sm uppercase tracking-wider opacity-0 group-hover:opacity-100 -translate-y-2 group-hover:translate-y-0 transition-all duration-300"
            >
              Explore
