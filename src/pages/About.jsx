...
const values = [
  {
    title: "Authenticity",
    description: "The real Nepal—genuine connections, not tourist shows.",
  },
  {
    title: "Sustainability",
    description: "Responsible tourism that supports mountain communities.",
  },
  {
    title: "Excellence",
    description: "Every detail matters. We never compromise.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                DowntoEarth Adventures began when our founder returned to his
                ancestral village. He saw an opportunity: to create trekking
                experiences that honored both the majesty of these mountains and
                the communities who call them home.
              </p>
              <p className="text-gray-400 leading-relaxed mb-8">
                Today we're a team of local Sherpas, Tamangs, and Gurungs. We
                share our culture, our stories, and our home with adventurers
